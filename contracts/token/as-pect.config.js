...
module.exports = {
   ...
   */
  include: ['./packages/state-manager/assembly/__tests__/**/*.spec.ts'],
  /**
   * A set of globs passed to the glob package that quality files to be added to each test.
   */
  add: ['./packages/state-manager/assembly/__tests__/**/*.include.ts'],
  /**
  ...
  coverage: ['./packages/state-manager/assembly/*.ts'],
  /**
